    ...
    <div class="card-body">
      <form action="{{ route('travel-package.store') }}" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" name="food" id="food" class="form-control" placeholder="Food" value="{{ old('food') }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="date" name="departure" id="departure" class="form-control" placeholder="Departure Date" value="{{ old('departure') }}">
        </div>
        <div class="form-group">
